...
var Module = typeof mc !== 'undefined' ? mc : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fxMainIdle')) {
        Object.defineProperty(Module['ready'], '_fxMainIdle', { configurable: true, get: function() { abort('You are getting _fxMainIdle on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fxMainIdle', { configurable: true, set: function() { abort('You are setting _fxMainIdle on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fxMainLaunch')) {
        Object.defineProperty(Module['ready'], '_fxMainLaunch', { configurable: true, get: function() { abort('You are getting _fxMainLaunch on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fxMainLaunch', { configurable: true, set: function() { abort('You are setting _fxMainLaunch on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fxMainQuit')) {
        Object.defineProperty(Module['ready'], '_fxMainQuit', { configurable: true, get: function() { abort('You are getting _fxMainQuit on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fxMainQuit', { configurable: true, set: function() { abort('You are setting _fxMainQuit on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fxMainTouch')) {
        Object.defineProperty(Module['ready'], '_fxMainTouch', { configurable: true, get: function() { abort('You are getting _fxMainTouch on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fxMainTouch', { configurable: true, set: function() { abort('You are setting _fxMainTouch on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var ASM_CONSTS = {
  115156: function() {gxView.onBufferChanged();},  
 115186: function($0, $1, $2, $3) {gxView.onFormatChanged($0, $1, $2, $3);},  
 115230: function($0) {gxView.onStart($0);},  
 115254: function() {gxView.onStop();}
};
...
/** @type {function(...*):?} */
var _fxMainIdle = Module["_fxMainIdle"] = createExportWrapper("fxMainIdle");

/** @type {function(...*):?} */
var _fxMainLaunch = Module["_fxMainLaunch"] = createExportWrapper("fxMainLaunch");

/** @type {function(...*):?} */
var _fxMainTouch = Module["_fxMainTouch"] = createExportWrapper("fxMainTouch");

/** @type {function(...*):?} */
var _fxMainQuit = Module["_fxMainQuit"] = createExportWrapper("fxMainQuit");
